...
api.add_resource(view.DocTypeListResource, '/doc_type', '/classify_doc_type', '/wordseg_doc_type')
api.add_resource(view.RelationDocTypeListResource, '/entity_doc_type')
