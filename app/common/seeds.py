...
class Seeds:
    ...
    def create_doc_type():
        ...
        if len(DocTypeModel().get_all()) == 0:
            doc_types = [
                {"app_id": 1, "created_by": 1, "doc_type_id": 1, "doc_type_name": "测试抽取项目1",
                 "nlp_task_id": int(NlpTaskEnum.extract), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 2, "doc_type_name": "测试抽取项目2",
                 "nlp_task_id": int(NlpTaskEnum.extract), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 3, "doc_type_name": "测试抽取项目3",
                 "nlp_task_id": int(NlpTaskEnum.extract), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 4, "doc_type_name": "测试抽取项目4",
                 "nlp_task_id": int(NlpTaskEnum.extract), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 5, "doc_type_name": "测试分类项目1",
                 "nlp_task_id": int(NlpTaskEnum.classify), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 6, "doc_type_name": "测试分类项目2",
                 "nlp_task_id": int(NlpTaskEnum.classify), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 7, "doc_type_name": "测试分类项目3",
                 "nlp_task_id": int(NlpTaskEnum.classify), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 8, "doc_type_name": "测试关系项目1",
                 "nlp_task_id": int(NlpTaskEnum.relation), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 9, "doc_type_name": "测试关系项目2",
                 "nlp_task_id": int(NlpTaskEnum.relation), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 10, "doc_type_name": "测试分词项目1",
                 "nlp_task_id": int(NlpTaskEnum.wordseg), "group_id": 1},
                {"app_id": 1, "created_by": 1, "doc_type_id": 11, "doc_type_name": "测试分词项目2",
                 "nlp_task_id": int(NlpTaskEnum.wordseg), "group_id": 1},
            ]
